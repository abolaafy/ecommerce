        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('mobile.verified.check') }}">
                        @csrf

                        <input name="link" type='hidden' value="{{  $_SERVER['HTTP_REFERER'] ?? 'http://localhost/shop7/public/'}}">
