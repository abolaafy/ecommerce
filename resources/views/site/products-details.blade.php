                                        ...
                                        <div class="images-container list_thumb">
                                            <div class="product-cover">
                                                <img class="js-qv-product-cover img-fluid"
                                                     src="{{url ('site/images/'.$item -> images[0] -> img ?? '')}}"
                                                        ...
                                                        @foreach($item -> images as $image)
                                                            <div class="item thumb-container col-md-6 col-xs-12 pt-30">
                                                                <img class="img-fluid thumb js-thumb  selected "
                                                                     data-image-medium-src="{{url('site/images/'.$image -> img)}}"
                                                                     data-image-large-src="{{url('site/images/'.$image -> img)}}"
                                                                     src="{{url('site/images/'.$image -> img)}}"
                                ...
                                <div class="col-lg-7 col-md-8 col-xs-12 mt-sm-20">
                                    <div class="product-information">
                                        <div class="product-actions">
                                            <form action="{{-- route('products.reviews.store',$item->id) --}}"
                                                ...
                                                <div class="productdetail-right col-12 col-lg-6 col-md-6">
                                                            ...
                                                            <div class="product-price " itemprop="offers" itemscope=""
                                                                ...
                                                                <div class="current-price">
                                                                  ...
                                                                  @else
                                                                   ...
                                                                   echo   '  <small style="text-decoration: line-through; color: #a3a3a3;font-weight: 500;" class="old-price">  '.$item->price.'</small>  <span class="price-item">'.$item->discount_price.'</span>';
                                                    ...
                                                    <div class="in_border end">
                                                        ...
                                                        <div class="pro-tag">
                                                            ...
                                                            @isset($item -> brand)
                                                                <div>
                                                                  {{-- @foreach($item->brandas$brand --}}
                                                                        <span><a href="">{{$brand -> name ?? $item -> name}}</a></span>
                                                                {{-- @endforeach --}}
                                                                </div>
                                                            @endisset
                                                        </div>
                                                    ...
                                                    <div id="_desktop_productcart_detail">
                                                        <div class="product-add-to-cart in_border">
                                                            ...
                                                            <a  class="addToWishlist  wishlistProd_22" style="cursor: pointer"
                                                        ...
                                                        @if(isset($item->attributes) && count($item->attributes) > 0 )
                                                            @foreach($item->attributes as $attribute)
                                                                <div class="product-variants-item">
                                                                    <span
                                                                        class="control-label">{{$attribute ->translations[0] ->name}} : </span>
                                                                    @if(isset($attribute['options']) && count($attribute ['options']) > 0 )
                                                                        <select {{-- onchange="chanePrice(this)" --}} class="select-options" data-product-attribute="1"
                                                                                name="{{$attribute -> name}}">
                        ...
                        <div class="container">
                            ...
                            <section class="relate-product product-accessories clearfix">
                                ...
                                @if( isset($related_items) && count($related_items) > 0 )
                                    @foreach($related_items as $_item)
                                <div class="products product_list grid owl-carousel owl-theme" data-autoplay="true"
                                    ...
                                    <div class="item  text-center">
                                        <div class="product-miniature js-product-miniature item-two first_item"
                                             data-id-product="{{$_item -> id }}" data-id-product-attribute="60" itemscope=""
                                             itemtype="http://schema.org/Product">
                                            <div class="product-cat-content">
                                                <div class="category-title">
                                                <div class="product-title" itemprop="name"><a
                                                        href="{{route('product.details',$_item -> slug)}}">{{$_item -> name}}</a></div>

                                            </div>
                                            <div class="thumbnail-container">

                                                <a href="{{route('product.details',$_item -> slug)}}"
                                                   class="thumbnail product-thumbnail two-image">
                                                    <img class="img-fluid image-cover"
                                                    <?php
                                                    $img1 = $_item ->images[0]->img ?? 'null';
                                                    $img2 = $_item->images[1]->img ?? 'null';
                                             ?>
                                                         src="{{ url('site/images/'.$img1) }}"
                                                         alt=""
                                                         data-full-size-image-url="{{url('site/images/'.$img1)}}"
                                                         width="600" height="600">
                                                    <img class="img-fluid image-secondary"
                                                         src="{{url('site/images/'.$img2)}}"
                                                         alt=""
                                                         data-full-size-image-url="{{url('site/images/'.$img2)}}"
                                                         width="600" height="600">
                                                </a>
                                            ...
                                            <div class="product-description">
                                                <div class="product-groups">
                                                    <div class="product-group-price">
                                                        <div class="product-price-and-shipping">
                                                             <span itemprop="price"
                                                                   class="price">{{$_item -> special_price ?? $_item -> price }}</span>
                                                            @if($_item -> special_price)
                                                                <span
                                                                    class="regular-price">{{$_item -> price}}</span>
                                                            @endif
                                                ...
                                                <div class="product-buttons d-flex justify-content-start"
                                                    ...
                                                    <a    class="addToWishlist  wishlistProd_22" href="#"
                                                       data-product-id="{{$_item -> id}}"
                                                    >
                                                        <a   class="quick-view hidden-sm-down"
                                                           data-product-id="{{$_item -> id}}">
...
<script>
    //alert( $(".input-group").val());
         ...
         $(".qty").click(function ()
         {
            ...
            if ($("#quantity_wanted").val() != 0)
             {
                 //alert ('sucddful ');
                  $('.price-item').html( $("#quantity_wanted").val() *   {{ $item->discount_price ??$item->price }});
          ...
          $(".add-to-cart").click(function(el)
        {
            ...
            $.ajax({
                ...
                @endauth
                @guest
                "{{ route('cart.store.session')}}",
                @endguest
                data: {
                    'item_id': $(this).attr('data-product-id'),
                    'selling_price': $('.price-item').html( ),
    ...
    $(".close-login-alert").click(function(){
        ...
        @endif
           ...
           $('.price-item').html(priceAttribute[$(this).val()] + + $('.price-item').html(  ) )

               // alert (priceAttribute[$(this).val()]);
        });
          ...
          //  alert (priceAttribute.price5);

           // var pricOption = priceAttribute.price++el.value;
           // alert ({{ $item->dicount ?? $item ->  price }})
             $('.price-item').html( {{ $item->dicount ?? $item ->  price }} + + priceAttribute[el.value] )
        }
        ...
        $(".add-to-cartf").click(function(el)
        {
            el.preventDefault();
