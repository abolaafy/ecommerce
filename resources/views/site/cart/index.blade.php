                                                ...
                                                <li class="cart-item">
                                                    <div class="product-line-grid row spacing-10">
                                                        ...
                                                        <span class="product-image media-middle">
                                                          <img class="img-fluid"
                                                            <?php
                                                                $img =$item[0]->images[0]->img??'';
                                                            ?>
                                                               src="{{ url('site/images/'.$img) }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 col-xs-12">
                                                                    <div class="product-line-info">
                                                                        <a class="label"
                                                                           href="{{ route('product.details',$item [0]->slug) }}"
                                                                           data-id_customization="0">{{$item[0] -> name}}</a>
                                                                    </div>
                                                                    ...
                                                                    <div class="product-line-info product-price">
                                                                       <span itemprop="price"
                                                                            ...
                                                                            <span
                                                                                class="regular-price">{{$item[0] -> selling_price}}</span>
                                                                            ...
                                                                            <div class="cart-line-product-actions shop-item">
                                                                                <a onclick="$(this).closest('.cart-item').remove()" class="remove-from-cart"
                                                                                   rel="nofollow"
                                                                                    ...
                                                                                    data-id-product="{{$item[0] -> id}}"
                                                                                    data-url-product="{{-- route('site.cart.update',$item[0]->slug) --}}"
                            ...
                            <div class="cart-summary">
                                <div class="cart-detailed-totals">
                                    <div class="cart-summary-products">
                                        <div class="summary-label">There are  ({{ count($items??[] )}}) items in your cart</div>
                                    </div>
                                ...
                                <div class="checkout text-xs-center card-block">
                                    <a href="{{-- route('payment',$item->subTotal()) --}}" type="button" class="btn btn-primary"> proceed to payment
                                    </a>
                                </div>
...
$.ajaxSetup({
        ...
        $(".remove-from-cart").click(function(e){
            ...
            $.ajax({
                type: 'get',
                url :"{{ route('cart.delete.session') }}",
                data: {
                    'item_id': $(this).attr('data-id-product'),
                 },
                success: function (data)
                {

                   if (data.sataus && data.cart)
                   {

                            $(".cart-items-count").html ( $(".cart-items-count").html () - 1  );
                   }
                }
            });
        });
