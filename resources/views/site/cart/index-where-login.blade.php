                                                                ...
                                                                <div class="col-sm-6 col-xs-12">
                                                                    <div class="product-line-info">
                                                                        <a class="label"
                                                                           ...
                                                                           data-id_customization="0">{{ $item->name}}</a>
                                                                    </div>

                                                                    <div class="product-line-info product-price">
                                                                       <span itemprop="price"

                                                                             class="price">{{ $item->selling_price ?? $item->price}}</span>
                        ...
                        <div class="cart-grid-right col-xs-12 col-lg-3">
                            <div class="cart-summary">
                                <div class="cart-detailed-totals">
                                    ...
                                    <div class="">
                                        <div class="cart-summary-line cart-total">
                                            ...
                                            <span class="value">{{total_price()}}</span> جنيه
                                        </div>
                                ...
                                <div class="checkout text-xs-center card-block">
                                    <a href="{{ route('payment',total_price())}}" type="button" class="btn btn-primary"> proceed to payment
                                    </a>
                                </div>
