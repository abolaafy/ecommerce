                ...
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="36-mini-speaker.html">
                            <span itemprop="name">القائمة المفضلة </span>
                        </a>
            ...
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    <div class="block-category hidden-sm-down">
                        <h1 class="h1">القائمة المفضلة </h1>
                    </div>
                    <section id="products" >
                        <div id="nav-top">
                        ...
                        <div id="categories-product">
                            <div id="js-product-list">
                                <div class="products product_list grid row" data-default-view="grid">
                                            ...
                                            <div class="item parent-item-{{$item->id}} col-lg-4 col-md-6 col-xs-12 text-center no-padding">
                                                ...
                                                height: 400px;" class="product-miniature js-product-miniature item-one"
                                                    ...
                                                    <div class="product-description">
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            onclick="deleteToWishlist({{ $item->id }})">


                                                                <i class="fa fa-hearft">حذف</i>
...
<script src="http://localhost/shop7/public/site/js/jquery-3.6.0.min.js"></script>
    <script>
        ...
        function deleteToWishlist (item_id)
        {
            window.value =item_id;
            ...
            $.ajax(
             {
                ...
                success: function (data)
                {
                    if(data.sataus  )
                    {
                        console.log(data);
                        $(".alert-modal2").show();
                        $(".text-message").html('تمت حذف المنتج من قائمة المفضلة بنجاح');
                        $(".parent-item-"+ window.value).remove();
                        $(".count-Wishlists").html( $(".count-Wishlists").html()-1  );

                    }
                    else
                    {
                        $(".text-message").html("حدث خطااثناء عمليا الحذف حاول لاحقا");
