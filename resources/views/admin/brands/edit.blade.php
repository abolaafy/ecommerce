                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
											...
											<input name="updateImg" value="{{$brand -> img}}" type="hidden">

                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img style="width: 150px; height: 100px;" src="{{asset('site/images/'.$brand -> img)}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                       @if (isset($brand ) &&get_langs_active () -> count () >= 1)
												@foreach ($brand -> brand_tarnaslation as $index => $brind )
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">  الاسم {{__('messages.'.$brind -> locale)}}
                                                                 </label>
