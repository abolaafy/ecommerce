...
@section('content')
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendors.update',$vendor -> id)}}"
                                            ...
                                            @csrf
                                             ...
                                             <input name="id" id="id" type="hidden"  value="{{$vendor->id}}"> 
											 <input type="hidden" name="old_img" value="{{'site/images/'.$vendor -> logo}}">

                                            
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img 
                                                        src="{{asset('site/images/'.$vendor -> logo)}}"
                                                        class="rounded-circle  height-250" alt="صورة القسم  ">
                                                </div>
                                            </div>
											<input name="update" value="rafe" type="hidden" id="update" >
    ...
    <script>
				...
				//	document.getElementById("oldImg").value =document.getElementById("newImg").src;
    </script>
