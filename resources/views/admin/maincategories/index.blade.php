                                        ...
                                        <table
                                            ...
                                            @isset($categories)
                                                @foreach($categories as $category)
													...
													src="{{asset ('site/images/maincategories/'.$category ->img)}}"></td>
                                                           <td>
                                                            <div class="btn-group" role="group"
                                                            aria-label="Basic example">
                                                                <a style="display: inline-block"  href="{{route('admin.maincategories.edit',$category -> id)}}"
                                                                ...
                                                                <button   style="display: inline-block" class="btn btn-outline-warning btn-sm-width box-shadow-3 mr-1 mb-1"
																	...
																	onclick="getTypeAction({{$category -> id}})"
                                                                       ...
                                                                       <a style="display: inline-block" href="{{route('admin.maincategories.delete',$category -> id)}}"
			...
			function openCat (id)
						{
							...
							xml.open('get' , 'main_categories/change_state_cat/'+id +"?value=1");
							xml.send();
						...
						function closeCat(id)
						{
							...
							var xml = new XMLHttpRequest();
							xml.open('get' , 'main_categories/change_state_cat/'+id);
							xml.send();
							xml.onreadystatechange = function ()
							{
								if (xml.readyState === 4 && xml.status === 200)
