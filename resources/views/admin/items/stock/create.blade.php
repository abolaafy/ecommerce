                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> اضاافة مخزون للمنتج ( {{$item -> name}} ) </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.items.stock.store')}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="manageStock">تتبع المستودع
                                                            </label>
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
																
																	<option value="0" >عدم اتاحه التتبع</option>
																	<option value="1" @if ($item -> manage_stock == 1) {{'selected'}}@endif
																		>اتاحة التتبع</option>
                                                ...
                                                <div class="row">
                                                  <!-- QTY  -->
                                                            ...
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  الحالة ">
																		...
																		<option value="0">غير متاح </option>
																		 ...
																		 <option value="1" @if ($item -> in_stock == 1){{'selected'}}@endif
																			 >متاح</option>
                                                    ...
                                                    <div class="col-md-6" style="display:@if ($item -> manage_stock == 1) {{'block'}} @else {{'none'}}@endif "  id="qtyDiv">
                                                        <div class="form-group">
															...
															<script>
															 ...
															 document.getElementById('manageStock').value = 1;
															</script>
                                                            @enderror
                                                        </div>
                                                    </div>
