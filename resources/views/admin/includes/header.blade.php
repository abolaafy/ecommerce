        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  {{ Auth::user('admin') ->name }}</span>
                </span>
                ...
                <span class="mr-1">{{ LaravelLocalization::getCurrentLocaleName() }}
                  <span
                      class="user-name text-bold-700">  <i class="fa fa-language" aria-hidden="true"></i>
                    </span>
                </span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                            <span id="number-notify" class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{ App\Models\Order::count()}}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100">
                                ...
                                <script>
                                  ...
                                  {
                                      $('#number-notify').html(1 + +  $('#number-notify').html());
                                //    alert(data.order.customer_name)
