<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" >
            ...
            <li class="nav-item active"><a href="{{route('admin.dashboard')}}"><i class="fa fa-home" aria-hidden="true"></i>
			...
			<i class="fa fa-language" aria-hidden="true"></i>
                ...
                <ul class="menu-content">
                    <li class="actives" ><a class="menu-item" href="{{route('admin.languages')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto"> اضافة لغة جديدة
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-list"></i>
                ...
                <span
                    class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\MainCategory::where('translation_lang',get_default_lang()) -> count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.maincategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
				...
				<li class="nav-item"><a href=""><i class="fa fa-archive" aria-hidden="true"></i>
                <span class="menu-title" data-i18n="nav.dash.main">الاقسام الفرعية  </span>
                <span
                    class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\SubCategory::where('translation_lang',get_default_lang())-> count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.subcategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            @endcan
            <li class="nav-item"><a href=""><i class="fa fa-ship" aria-hidden="true"></i>
                <span class="menu-title" data-i18n="nav.dash.main">المتاجر  </span>
                <span
                    class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Vendor:: count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.vendors')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
...
@can('brands')
            ...
            <li class="nav-item">
                <a href=""><i class="fa fa-ravelry" aria-hidden="true"></i>
                ...
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.brands')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.brands.create')}}"
                                          data-i18n="nav.dash.ecommerce"> أضافة ماركة جديدة</a>
                    </li>
                </ul>
            </li>
            @endcan
 ...
 <li class="nav-item">
                <a href=""><i class="fa fa-product-hunt" aria-hidden="true"></i>
                    ...
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">{{App\Models\Item::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.items')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.items.general.create')}}"
                                          data-i18n="nav.dash.ecommerce">اضافة منتج جديد</a>
                    </li>
                </ul>
            </li>
            @endcan
 <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.offers')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.offers.create')}}"
                                          data-i18n="nav.dash.ecommerce"> أضافة عرض جديد</a>
                    </li>
                </ul>
            </li>
 <li class="nav-item">
                <a href=""><i class="fa fa-handshake-o" aria-hidden="true"></i>


                    <span class="menu-title" data-i18n="nav.dash.main">الصلاحيات </span>
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">{{App\Models\Rule::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.rules')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.rules.create')}}"
                                          data-i18n="nav.dash.ecommerce"> أضافة صلاحية</a>
                    </li>
                </ul>
            </li>
            @can('users')
 ...
 <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.users')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.users.create')}}"
                                          data-i18n="nav.dash.ecommerce"> اضافة عضو</a>
                    </li>
                </ul>
            </li>
            @endcan
...
<i class="fa fa-plus-circle" aria-hidden="true"></i>
                ...
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.attributes')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.attributes.create')}}"
                                          data-i18n="nav.dash.ecommerce">  اضافة خاصية جديدة </a>
                    </li>
                </ul>
            </li>
            @endcan
            <li class="nav-item">
                <a href="">
                    ...
                    <span class="menu-title" data-i18n="nav.dash.main"> القوائم الاضافية</span>
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">{{  App\Models\Slider::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.sliders')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
				<ul class="menu-content">
                    <li class="actives"><a class="menu-item" href="{{route('admin.sliders.images.create')}}"
                                          data-i18n="nav.dash.ecommerce">  اضافة قائمة جديدة </a>
                    </li>
                </ul>
            </li>
