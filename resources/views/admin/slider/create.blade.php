                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                               action="{{route('admin.sliders.images.save.db')}}"
                                              method="POST"
...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            ,
            url: "{{ route('admin.sliders.images.store.folder') }}", // Set the url
            success:
                function (file, response) {
                    $('form').append('<input type="hiddenf" name="imgs[]" value="' + response.name + '">')
            ...
            removedfile: function (file) {
                ...
                $('form').find('input[name="imgs[]"][value="' + name + '"]').remove()
            }
            ,
