...
<link rel="shortcut icon" type="image/x-icon" href="/savemart/img/favicon.ico?1531456858">
  ...
  <link href="https://fonts.googleapis.com/css?family=Oswald:300,400,500,600,700,900" rel="stylesheet">
       ...
       <link rel="stylesheet" href="{{asset('site/themes/vinova_savemart/assets/cache/theme-78026624.css')}}" type="text/css" media="all">
       @endif
  ...
  <body id="index" class="lang-ar lang-rtl country-gb currency-gbp layout-full-width page-index tax-display-enabled">
    ...
    <main id="main-site" class="displayhomenovthree">
			  ...
			  <header id="header" class="header-1 sticky-menu">
					...
					@include('site.includes.header-mobile')
...
@foreach ($sliders as $slider)
      ...
      <a href="#"> <img
         src="{{ asset('site/images/'.$slider -> img) }}" alt="banner3d-1"  alt="" title="#htmlcaption_42" />
    </a>
...
@if (LaravelLocalization::getCurrentLocaleDirection() == 'rtsxsxsxsxsxl')
...
<script type="text/javascript" src="{{asset('site/js/vue.js')}}" ></script>


        <script type="text/javascript" src="{{asset('site/js/bottom-3c96ed23.js')}}" ></script>
