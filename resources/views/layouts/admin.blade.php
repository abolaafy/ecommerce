...
<head>
    ...
    <link rel="shortcut icon" type="{{asset('image/x-icon" href="admin/images/ico/favicon.ico')}}">
    ...
    <script>
        ...
        var pusher = new Pusher('691386f7c408573b3de6', {
          cluster: 'eu'
        });
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/css-rtl/plugins/file-uploaders/dropzone.min.css')}}">
...
<!--start content--><x:notify-messages />
@yield('content')
<!-- End Content -->
...
<!-- BEGIN VENDOR JS-->
pt src="https://sdk.form.run/js/v2/formrun.js"></script>
...
<script src="{{asset('admin/vendors/js/tables/datatable/dataTables.buttons.min.j')}}s"
        type="text/javascript"></script>
@notifyJs
